...
const SignIn = ({setRoute}) => {
    ...
    return (
    <div className="flex justify-center items-center w-[50vw] h-[100vh] translate-y-[-10%]">
        <div className="flex flex-col flex-1 items-center justify-center mt-2 px-6 py-12 shadow-2xl bg-blue-950 rounded-xl bg-opacity-40 min-w-[350px] max-w-[50%] g:px-8">
            ...
            <p className="mt-10 text-sm text-center text-gray-500">
                Not registered yet?{' '}
                <a href="#" className="text-xl font-semibold leading-6 text-blue-600 hover:text-blue-500">
                Register now!
                </a>
            </p>
            </div>
